...
class NetworkScanDb(models.Model):
    ...
    # Human-readable scan type/profile (e.g., "Full and fast")
    scan_type = models.TextField(blank=True, null=True)
    # Optional runner PID for live tools (e.g., Nmap) to allow Stop
    runner_pid = models.TextField(blank=True, null=True)
