...
API_DESCRIPTION = (
    ...
    "authenticated scanning (DAST) and covers the whole applications "
...
urlpatterns = [
    ...
    # Static scan API endpoints (disabled)
    path("v1/sast-scans/", lambda request, *a, **k: JsonResponse({"detail": "SAST disabled"}, status=404)),
    path("v1/sast-scans/<str:uu_id>/", lambda request, *a, **k: JsonResponse({"detail": "SAST disabled"}, status=404)),
    ...
    # Audit Logs
    path("v1/audit-logs/", views.AuditLogList.as_view(), name="audit_log_list"),
    # Notifications
    path("v1/notifications/", views.NotificationList.as_view(), name="notification_list"),
    path("v1/notifications/preferences/", views.NotificationPreferences.as_view(), name="notification_preferences"),
    # Report Download
    path("v1/reports/download/", views.ReportDownloadAPI.as_view(), name="report_download_api"),
]
