...
class CloudScanList(APIView):
    ...
    def get(self, request):
        ...
        if request.path[:4] == "/api":
            ...
            return render(
                request,
                "cloudscanners/scans/list_scans.html",
                {"all_scans": scan_list, "message": all_notify},
            )


class CloudScanVulnInfo(APIView):
    permission_classes = [IsAuthenticated | permissions.VerifyAPIKey]
...
class CloudScanVulnMark(APIView):
    renderer_classes = [TemplateHTMLRenderer]
    template_name = "cloudscanners/scans/list_vuln_info.html"
...
class CloudScanDetails(APIView):
    renderer_classes = [TemplateHTMLRenderer]
    template_name = "cloudscanners/scans/vuln_details.html"
    ...
    def get(self, request):
        ...
        vul_dat = list(CloudScansResultsDb.objects.filter(
...
class CloudScanDelete(APIView):
    renderer_classes = [TemplateHTMLRenderer]
    template_name = "cloudscanners/scans/list_scans.html"
...
class CloudScanVulnDelete(APIView):
    renderer_classes = [TemplateHTMLRenderer]
    template_name = "cloudscanners/scans/list_vuln_info.html"
...
class CloudScanVulnList(APIView):
    renderer_classes = [TemplateHTMLRenderer]
    template_name = "cloudscanners/scans/list_vuln.html"
    ...
    def get(self, request):
        ...
        return render(
            request,
            "cloudscanners/scans/list_vuln.html",
            {
                "all_vuln": all_vuln,
                "scan_id": scan_id,
            },
