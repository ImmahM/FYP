...
urlpatterns = [
    ...
    path("nikto_debug/", views.NiktoDebug.as_view(), name="nikto_debug"),
    path("nikto_rescan/", views.NiktoRescan.as_view(), name="nikto_rescan"),
    path("nikto_stop/", views.NiktoStop.as_view(), name="nikto_stop"),
