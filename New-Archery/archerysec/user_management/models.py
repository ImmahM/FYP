...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    notify_in_app = models.BooleanField(default=True, help_text="Receive in-app notifications")
    notify_on_scan_start = models.BooleanField(default=False, help_text="Notify when a scan starts")
    notify_on_scan_complete = models.BooleanField(default=True, help_text="Notify when a scan completes")
    notify_on_scan_fail = models.BooleanField(default=True, help_text="Notify when a scan fails")
    notify_critical_only = models.BooleanField(default=False, help_text="Only notify for critical/high severity findings")
