...
urlpatterns = [
    ...
    path("self_password/", views.SelfPasswordUpdateView.as_view(), name="self_password"),
    ...
    path("notification_prefs/", views.NotificationPrefsUpdate.as_view(), name="notification_prefs"),
]
