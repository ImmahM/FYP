...
def download_report(request):
    ...
    context = {
        "dynamic_results": DynamicScan.objects.all() if "dynamic" in scan_type else [],
        "static_results": StaticScan.objects.all() if "static" in scan_type else [],
        "infrastructure_results": InfraScan.objects.all() if "infrastructure" in scan_type else [],
        "cloud_results": CloudScan.objects.all() if "cloud" in scan_type else [],
    }
